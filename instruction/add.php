...
<!DOCTYPE HTML>
  <html>
    <head>
      <title>Tanya Anisimova : Student Instruction - Add</title>
      ...
      <script>
        jQuery(document).ready(function(){
          ...
          $("#submit").click(function() {
            alert("This would submit the form and create a new lesson.");
          });
          ...
          function createLinks() {
            ...
            if (authenticatedUser !== null) {
              ...
              if (authenticatedUser.login === "tanya") {
                ...
                let add = $('<li class="active"><a href="add.php">Add</a></li>');
           ...
           <div class="fill">
            ...
            <div class="row addLesson">
               ...
               <div class="col-sm-6 col-xs-12">
                 ...
                 <button type="submit" id="submit" class="btn btn-primary">Add Lesson</button>
